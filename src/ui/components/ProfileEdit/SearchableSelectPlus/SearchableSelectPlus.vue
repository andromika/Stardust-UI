...
import './SearchableSelectPlus.scss';

defineOptions({ inheritAttrs: false });

export interface SearchableSelectPlusOption {
  value: string | number;
  label: string;
  [key: string]: unknown;
}
...
function setFocusedRef(el: unknown, _opt: SearchableSelectPlusOption, idx: number) {
...
function select(opt: SearchableSelectPlusOption) {
